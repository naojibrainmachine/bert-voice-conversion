...
def train(model,params,batch_size):
    acc=[]
    acc_spec=[]
    wav_files_list = glob.glob(default_config["data_ss_train"])
    print(len(wav_files_list))
    #print(default_config["data_ss_train"])
...
if __name__ == "__main__":
    ...
    if isContinue==True:
        try:
            load_weight("ckp","params_ss_pre_train",params_ss)
